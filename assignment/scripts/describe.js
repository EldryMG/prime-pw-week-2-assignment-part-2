...
// We make a conditional statement to check if the variable name is the string Mary, we console.log 'Hi, Mary!'
// if the variable is anything other than 'Mary', we console.log 'How do you do?'
//
